...
--------------------------------------------------------------------------------------------------
-- show the result to display employees with manager 2, and then employees with amanger 102 and employees
-- with manager 4
...
--------------------------------------------------------------------------------------------------
select first_name, last_name, manager_id, null as "Customer ID", email
from employees

union all

select first_name, last_name, 0, customer_id, email
from contacts;


----
select e.first_name, e.last_name, e.manager_id, m.last_name as "Manager Last Name" ,null as "Customer Id", 
...
select co.first_name, co.last_name, null, null, co.customer_id, cu.name 
from contacts co
